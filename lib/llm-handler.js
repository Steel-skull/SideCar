...
For MINOR NPCs, provide updates using these paths:
- data.notes - Brief description of who they are
- data.sentiment - Their attitude toward the main character
- data.lastContext - Summary of last interaction

For MAJOR NPCs, provide updates using the full tracker paths:
- trackers.status.health - Physical condition
- trackers.status.mood - Emotional state
- trackers.status.conditions - Array of active conditions
- trackers.personality.traits - Array of personality traits
- trackers.personality.goals - Array of current goals
- trackers.personality.fears - Array of fears/weaknesses
- trackers.personality.motivations - What drives them
- trackers.appearance.clothing - What they're wearing
- trackers.appearance.physical - Physical description
- trackers.relationships.[Name].sentiment - How they feel about someone
- trackers.relationships.[Name].trustLevel - Numeric trust 0-100
- trackers.knowledge - Array of things this NPC knows
- narrativeRole.archetype - Character archetype (Mentor, Antagonist, etc.)
- narrativeRole.storyFunction - Their narrative purpose
- timeline - Array of events involving this NPC
  ...
  "npcClassifications": [
    {
      ...
      "updates": [
        { "op": "set", "path": "data.notes", "value": "For minor: description" },
        { "op": "set", "path": "trackers.status.mood", "value": "For major: mood" },
        { "op": "add", "path": "trackers.personality.traits", "value": "For major: trait" }
      ]
    }
  ],

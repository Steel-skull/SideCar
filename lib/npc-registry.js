...
export class NPCRegistry {
    ...
    /**
     * Alias for getNPC - get an NPC by ID
     */
    get(npcId) {
    ...
    /**
     * Alias for deleteNPC - delete an NPC by ID
     */
    async delete(npcId) {
        return this.deleteNPC(npcId);
    }
    ...
    /**
     * Get the raw registry data object
     * Used by ContextInjector for formatting NPC context
     * @returns {Object|null} The registry data or null if not loaded
     */
    getRegistryData() {
        return this.registry;
    }
